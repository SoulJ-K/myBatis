...
<body>
	...
	<!------------- 0_1.로그인한 회원만 게시물 보기를 하기 위해 다음과 같은 조건 추가  -------------->
			...
			<div class="pagingArea" align="center">
				...
				<c:if test="${ pi.currentPage > 1 }">
					...
					<c:url var="blistBack" value="${ loc }">
						<!-- ${loc} : 현재 ContextPath/url을 함께 갖고 있는 것 
							 url에는 기본적으로 contextPath가 들어가있어서 가능함
						-->
	...
	<!-------------- 0_2. 로그인하지 않은경우 ---------------->
	<c:if test="${ empty loginUser }">
		<c:set var="message" value="로그인 해주세요" scope="request"/>
